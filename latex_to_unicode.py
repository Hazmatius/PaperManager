...
class AccentConverter:
	...
	def __init__(self):
		...
		self.translation_rule, self.strip_rule, self.accent_detector = self.__create_translation_rules()
	...
	def __create_translation_rules(self):
		...
		self.populate_encode_dict( encode_dict, strKey_umlaut, strValue_umlaut,  '\\"{', "}" )
		regex_detectors.append( re.compile(r'\\"{ *[a-zA-Z]{1} *}') )
		self.populate_strip_dict(strip_dict, strValue_umlaut, strKey_umlaut)
		...
		self.populate_encode_dict( encode_dict, strKey_acute, strValue_acute, "\\'{", "}" )
		regex_detectors.append( re.compile(r"\\'{ *[a-zA-Z]{1} *}") )
		self.populate_strip_dict(strip_dict, strValue_acute, strKey_acute)
		...
		self.populate_encode_dict( encode_dict, strKey_hungarian, strValue_hungarian, "\\H\\", "" )
		regex_detectors.append( re.compile(r'\\H *\\[a-zA-Z]{1} *') )
		self.populate_strip_dict(strip_dict, strValue_hungarian, strKey_hungarian)
		...
		self.populate_encode_dict( encode_dict, strKey_grave, strValue_grave, "\\`{", "}" )
		regex_detectors.append( re.compile(r"\\`{ *[a-zA-Z]{1} *}") )
		self.populate_strip_dict(strip_dict, strValue_grave, strKey_grave)
		...
		self.populate_encode_dict( encode_dict, strKey_circumflex, strValue_circumflex, "\\^{", "}" )
		regex_detectors.append( re.compile(r"\\\^{ *[a-zA-Z]{1} *}") )
		self.populate_strip_dict(strip_dict, strValue_circumflex, strKey_circumflex)
		...
		self.populate_encode_dict( encode_dict, strKey_hraceck, strValue_hraceck, "\\v\\", "" )
		regex_detectors.append( re.compile(r'\\v *\\[a-zA-Z]{1} *') )
		self.populate_strip_dict(strip_dict, strValue_hraceck, strKey_hraceck)
		...
		self.populate_encode_dict( encode_dict, strKey_breve, strValue_breve, "\\u\\", "" )
		regex_detectors.append( re.compile(r'\\u *\\[a-zA-Z]{1} *') )
		self.populate_strip_dict(strip_dict, strValue_breve, strKey_breve)
		...
		self.populate_encode_dict( encode_dict, strKey_cedilla, strValue_cedilla, "\\c\\", "" )
		regex_detectors.append( re.compile(r'\\c *\\[a-zA-Z]{1} *') )
		self.populate_strip_dict(strip_dict, strValue_cedilla, strKey_cedilla)
		...
		self.populate_encode_dict( encode_dict, strKey_dot, strValue_dot, "\\.{", "}" )
		regex_detectors.append( re.compile(r"\\\.{ *[a-zA-z]{1} *}" ) )
		self.populate_strip_dict(strip_dict, strValue_dot, strKey_dot)
		...
		self.populate_encode_dict( encode_dict, strKey_dot_under, strValue_dot_under, "\\d\\", "" )
		regex_detectors.append( re.compile(r'\\d *\\[a-zA-Z]{1} *') )
		self.populate_strip_dict(strip_dict, strValue_dot_under, strKey_dot_under)
		...
		self.populate_encode_dict( encode_dict, strKey_ogonek, strValue_ogonek, "\\k\\", "" )
		regex_detectors.append( re.compile(r'\\k *\\[a-zA-Z]{1} *') )
		self.populate_strip_dict(strip_dict, strValue_ogonek, strKey_ogonek)
		...
		self.populate_encode_dict( encode_dict, strKey_tilde, strValue_tilde, "\\~{", "}" )
		regex_detectors.append ( re.compile('\\\~{ *[a-zA-Z]{1} *}') )
		self.populate_strip_dict(strip_dict, strValue_tilde, strKey_tilde)
		...
		self.populate_encode_dict( encode_dict, strKey_macron, strValue_macron, "\\={", "}" )
		regex_detectors.append( re.compile('\\\={ *[a-zA-Z]{1} *}') )
		self.populate_strip_dict(strip_dict, strValue_macron, strKey_macron)
		...
		self.populate_encode_dict( encode_dict, strKey_bar_under, strValue_bar_under, "\\b\\", "" )
		regex_detectors.append( re.compile(r'\\b *\\[a-zA-Z]{1} *') )
		self.populate_strip_dict(strip_dict, strValue_bar_under, strKey_bar_under)
		...
		regex_detectors.append( re.compile(r'\\r *\\[a-zA-Z]{1} *') )
		self.populate_strip_dict(strip_dict, strValue_ring, strKey_ring)

		return encode_dict, strip_dict, regex_detectors
	...
	def populate_strip_dict(self, strip_dict, strKey, strValue):
		s_key = strKey.split(' ')
		s_value = strValue.split(' ')
	...
	def convert_char(self, c):
		if c in self.strip_rule.keys():
			return self.strip_rule[c]
		else:
			return c

	def remove_Tex_Accents(self, s, utf8_or_ascii=1):
		s = self.decode_Tex_Accents(s, utf8_or_ascii)
		s = ''.join([self.convert_char(c) for c in s])
		return s
